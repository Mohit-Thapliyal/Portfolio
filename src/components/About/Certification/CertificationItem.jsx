  ...
  return (
    <>
      <motion.li
        ...
        className="flex p-3 text-left duration-200 rounded-lg shadow-lg cursor-default font-nunito bg-nosecondary lg:px-8 lg:py-6 lg:hover:scale-105"
      >
        <div className="flex flex-col justify-between gap-5 font-quicksand">
          ...
          <a
            className="px-10 py-1 text-sm font-bold rounded-sm text-primary w-fit bg-highlight"
            href={props.link}
            target="certificate"
          >
            Link
