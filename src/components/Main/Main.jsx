    ...
    <AnimatedPage>
      <main className="relative flex flex-col justify-center w-screen min-h-screen text-white font-nunito md:justify-center ">
        ...
        <div className="flex flex-col-reverse cursor-default lg:flex-row justify-end md:justify-evenly items-center xl:gap-0 gap-7 py-[5vh] md:py-[7vh] lg:py-[17vh] xl:py-[23vh]">
          ...
          <div className="flex justify-center bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-secondary via-tertiary to-secondary w-4/6  rounded-3xl md:rounded-[1em] hover:scale-105 duration-300 ease-linear md:justify-end md:w-5/12 lg:w-3/12">
            <img
              src={profilePic}
              alt="profile pic"
